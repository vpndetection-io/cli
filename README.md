...
curl -LO https://github.com/vpndetection-io/cli/releases/download/v1.3.1/vpndetection_1.3.1_linux_amd64.tar.gz
tar -xzf vpndetection_1.3.1_linux_amd64.tar.gz
